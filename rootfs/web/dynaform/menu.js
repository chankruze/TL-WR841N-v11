...
//	directory level: 0: directory has no branches;  1: directory level 1;  2:level 2;   and so on
	...
	"ConnModeCfgRpm", 		   		0,		2,  	    str_menu.ntwConnMode,
	"MobileCfgRpm", 			        0,		2,  	    str_menu.ntwMobile,
	"WanCfgRpm", 			        0,		2,  	    str_menu.ntwWan,
	"BridgeCfgRpm",					0,		2,			str_menu.ntwIptv,
	...
	"LanBrModeRpm",					0,		2,			str_menu.ntwRussiaVlan, 
...
//	"GuestNetworkRpm",			0,		0,			str_menu.guestNetwork,
...
/* add for Guest_Network */
	"", 							0,		1,  		str_menu.guestNetCfg,
	"GuestNetWirelessCfgRpm",		0,		2,			str_menu.guestNetWirelessCfg,
	"GuestNetUsbCfgRpm",			0,		2,			str_menu.guestNetUsbCfg,
/*end add*/
	...
	/* added by kuangguiming 26Sep12 for VPN */
	"",								0,		1,			str_menu.vpnMain,
	"IkeRpm", 		    			0,		2,  	    str_menu.vpnIke,
	"IpsecRpm", 	    			0,		2,  	    str_menu.vpnIpsec,
	"SaListRpm", 		    		0,		2,  	    str_menu.vpnSaList,
	...
	"NatStatusCfgRpm",                 0,      0,          str_menu.nat,

	"PortMirrorCfgRpm",                 0,      0,          str_menu.portMirror,
	...
	/* for Smart DMZ, we can just select one between DMZ and Smart DMZ */
	"SmartDMZRpm",					0,		2,  	    str_menu.frwSmartDMZ, 	
	...
	"YandexDnsRpm",					0,		0,		str_menu.yandexDns,
	...
	"Tr069CfgRpm",				0,		2,		str_menu.tr069Settings,
	...
	"SessionRefreshRpm",             0,      2,          str_menu.sessionRefresh,
